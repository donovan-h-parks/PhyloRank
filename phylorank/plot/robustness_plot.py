...
class RobustnessPlot(AbstractPlot):
    ...
    def run(self, rank, input_tree_dir, full_tree_file, derep_tree_file, taxonomy_file, output_prefix, min_children,
            title):
        ...
        tree = dendropy.Tree.get_from_path(full_tree_file,
                                           ...
                                           rooting='force-rooted',
                                           preserve_underscores=True)
        full_rel_dist, _full_dist_components, polyphyletic = self.rel_dist_to_specified_groups(tree, groups_to_consider,
                                                                                               groups)
